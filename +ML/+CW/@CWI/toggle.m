...
%ML.CW.CWI/toggle Toggle selection
%   ML.CW.CWI/toggle(I, K) toggles the K-th option of the selectable list
...
%
%   Note: This method is related to <a href="matlab:help M.CW.CWI.select">ML.CW.CWI/select</a> and should not be 
%   called directly by the end user of the class.
%
%   See also ML.CW.CWI, ML.CW.CWI/select
%
%   More on <a href="matlab:ML.doc('ML.CW.CWI.toggle');">ML.doc</a>
